...
export const variableDefinitions: Record<string, VariableDefinition> = {
    ...
    xorWiringSeed: {
        ...
        type: 'array',
        label: 'Starting bits (wiring figure)',
        description: 'The four bits the register starts from in the tap-wiring figure',
    },
    xorWiringTaps: {
        defaultValue: [1, 0, 0, 1],
        type: 'array',
        label: 'Tapped cells',
        description: 'One flag per cell: 1 when its wire is clipped to the XOR gate',
    },
    xorWiringCount: {
        defaultValue: 0,
        type: 'number',
    ...
    answer_cycle_five_cell_period: {
        defaultValue: '',
        type: 'text',
        label: 'Five-cell period answer',
        description: 'Student answer for the longest possible cycle of a five-cell register',
        placeholder: '??',
        correctAnswer: '31',
        color: '#8E90F5',
        bgColor: 'rgba(142, 144, 245, 0.15)',
